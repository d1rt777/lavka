...
declare function getPageContextFromHooksClient_firstRender(pageContext: PageContextSerialized & PageContextBegin & PageContextConfig & {
    ...
    previousPageContext: ({
        ...
        pageExports: Record<string, unknown>;
        isBaseMissing?: true;
    }, "Page" | "abortReason" | "config" | "configEntries" | "data" | "exports" | "exportsAll" | "from" | "pageExports" | "pageId" | "routeParams" | "source" | "sources"> & {
        isClientSide: true;
        isPrerendering: false;
        cspNonce?: undefined;
        headers?: undefined;
        ...
        urlPathname: string;
        url: string;
    }, "pageContextsAborted" | "previousPageContext" | ("Page" | "data" | "globalContext")> & {
        previousPageContext: {
            pageId: string;
        } | null;
    } & {
