...
declare function execHook<PageContext extends PageContextExecHook & PageContextConfig>(hookName: HookName, pageContext: PageContext, getPageContextPublic: (pageContext: PageContext) => PageContext): Promise<{
    hookFn: (arg: import("../createPageContextShared.js").PageContextCreated, ...rest: unknown[]) => unknown;
    hookTimeout: import("./getHook.js").HookTimeout;
    hookName: import("../../types/Config.js").HookNameOld;
    hookFilePath: string;
    hookReturn: unknown;
}[]>;
...
declare function execHookList<PageContext extends PageContextExecHook>(hooks: HookInternal[], pageContext: PageContext, getPageContextPublic: (pageContext: PageContext) => PageContext): Promise<{
    hookFn: (arg: import("../createPageContextShared.js").PageContextCreated, ...rest: unknown[]) => unknown;
    hookTimeout: import("./getHook.js").HookTimeout;
    hookName: import("../../types/Config.js").HookNameOld;
    hookFilePath: string;
